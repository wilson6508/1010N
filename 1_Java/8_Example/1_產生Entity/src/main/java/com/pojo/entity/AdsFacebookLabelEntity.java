...
/**
 * Author: RD3_wilson
 * CreateTime: 2023/9/27 - 上午 11:39
 * Version: 1.0
 * Description:
 */
@Entity
@Table(name = "ads_facebook_label", schema = "opv_auth_dev", catalog = "")
public class AdsFacebookLabelEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        AdsFacebookLabelEntity that = (AdsFacebookLabelEntity) o;
